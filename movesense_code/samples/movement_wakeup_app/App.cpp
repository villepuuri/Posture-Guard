...
MOVESENSE_PROVIDER_DEF(MovementWakeupApp)
...
// explicit definition of Logbook memory are (see LOGBOOK_EEPROM_MEMORY_AREA macro in movesense.h and eeprom_logbook_app).
...
APPINFO_NAME("Sample Movement Wakeup");
